...
class Generator:
    ...
    def generate_images(self, draw_circle=True, draw_square=False, directory="dataset"):
        filename = "none_"
        ...
        plt.savefig(f'{directory + "/" + filename}{num_images + 1}.png', bbox_inches='tight', pad_inches=0)
        plt.close()
        self.num_images++
