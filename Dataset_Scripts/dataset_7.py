...
sar_folder_train = 'Datasets/Dataset_7/train/squares_at_right'
sar_folder_test = 'Datasets/Dataset_7/test/squares_at_right'

car_folder_train = 'Datasets/Dataset_7/train/circles_at_right'
car_folder_test = 'Datasets/Dataset_7/test/circles_at_right'

data_folder = 'Datasets/Dataset_7/data'
seed = 222
np.random.seed(seed)
...
for j in range(2):
    ...
    for i in range(size):
        ...
        if do_2_sq is False:
            ...
            # write and add square at left
            sar_sq_writer.writerow([f'sar_{counter}.png', sq_left_x, sq_left_y, length, sq_left_angle, area, area, sq_left_dfc, sq_left_dfc_f, left_corners, sq_left_color, bg_color, "Left", "False", variant])
