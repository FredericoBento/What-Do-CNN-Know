...
# Dataset 7_3
# 7_1 but with different sizes

sar_folder_train = 'Datasets/Dataset_7_3/train/squares_at_right'
sar_folder_test = 'Datasets/Dataset_7_3/test/squares_at_right'

car_folder_train = 'Datasets/Dataset_7_3/train/circles_at_right'
car_folder_test = 'Datasets/Dataset_7_3/test/circles_at_right'

data_folder = 'Datasets/Dataset_7_3/data'
seed = 323
np.random.seed(seed)
    ...
    while counter <= size:
        ...
        if do_2_ci is False:
            ...
            while all_ok is False:
                ...
                ci_left_x = np.random.uniform(0 + ci_left_radius, img_width - ci_left_radius - 20)
                ci_left_y = np.random.uniform(0 + ci_left_radius, img_height - ci_left_radius - 20)

                if du.circle_out_of_bounds(ci_left_x, ci_left_y, ci_left_radius, img_width, img_height) is True:
                    continue
            ...
            cal = patches.Circle((ci_left_x, ci_left_y), ci_left_radius, color=ci_left_color)
            ci_left_visible_area = du.calculate_visible_area_circle(ci_left_x, ci_left_y, ci_left_radius, img_width, img_height)
            ci_left_cut = du.circle_is_cut(ci_left_x, ci_left_y, ci_left_radius, img_width, img_height)
        ...
        while all_ok is False:
            ...
            if intersection_counter_reached is False:
                ...
                if do_2_ci is False:
                    ...
                    while intersect is False:
                        ci_x = np.random.uniform(ci_left_x - ci_left_radius, ci_left_x + ci_left_radius)
                        ci_y = np.random.uniform(ci_left_y - ci_left_radius, ci_left_y + ci_left_radius)
                        intersect = du.circle_intersect_circle(ci_x, ci_y, radius, ci_left_x, ci_left_y, ci_left_radius)
            else:
            ...
            if do_2_ci is False:
                ...
                if du.circle_intersect_circle(ci_x, ci_y, radius, ci_left_x, ci_left_y, ci_left_radius) is True:
                    ci_intersected = True
        ...
        if anti_intersect_block is False:
            ...
            if do_2_ci is False:
                ...
                car_ci_writer.writerow([filename, ci_left_x, ci_left_y, ci_left_radius, ci_left_area, ci_left_visible_area, ci_left_dfc, ci_left_dfc_f, ci_left_color, bg_color, "Left", intersected, ci_left_cut, variant])
...
for j in range(2):
    ...
    while counter <= size:
        ...
        if do_2_sq is False:
            # add circle at left
            all_ok = False
            radius = np.sqrt(np.random.uniform(min_square_area, 150 * 150)) / 2
            while all_ok is False:
            ...
            while all_ok is False:
                ...
                sq_left_x = np.random.uniform(0, img_width - sq_left_length - 20)
                sq_left_y = np.random.uniform(0, img_height - sq_left_length - 20)
            ...
            sq_left_visible_area = du.calculate_visible_area_square(sq_left_x, sq_left_y, sq_left_length, sq_left_angle, img_width, img_height)
        ...
        while all_ok is False:
            ...
            if intersection_counter_reached is False:
                ...
                if do_2_sq is False:
                    ...
                    while intersect is False:
                        diagonal = np.sqrt(sq_left_length ** 2 + sq_left_length ** 2)
        ...
        if anti_intersect_block is False:
            ...
            if do_2_sq is False:
                ...
                # write and add square at left
                sar_sq_writer.writerow([filename, sq_left_x, sq_left_y, sq_left_length, sq_left_angle, sq_left_area, sq_left_visible_area, sq_left_dfc, sq_left_dfc_f, left_corners, sq_left_color, bg_color, "Left", intersected, sq_left_cut, variant])
                if sq_intersected is False:
                    ax.add_patch(left_square)
